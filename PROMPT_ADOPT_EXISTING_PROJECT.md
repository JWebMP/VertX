...
- Repository URL / local path: https://github.com/JWebMP/VertX.git
- Org and project name: JWebMP / Vert.X
- Short description: Configures the GuicedEE Vertx library for JWebMP Usage
